      ...
      if(this.field_73132_a instanceof EntityItemFrame && this.field_73136_m % 10 == 0) {
         ...
         if(var24 != null && var24.func_77973_b() instanceof ItemMap) {
            ...
            while(var27.hasNext()) {
               ...
               var26.func_76191_a(var30, var24);
               if(var30.field_71135_a.func_72568_e() <= 5) {
                  Packet var31 = Item.field_77744_bd.func_77871_c(var24, this.field_73132_a.field_70170_p, var30);
                  if(var31 != null) {
                     var30.field_71135_a.func_72567_b(var31);
                  }
               }
            }
         }
         ...
         if(this.field_73132_a.field_70154_o == null) {
            ...
            DataWatcher var32 = this.field_73132_a.func_70096_w();
            if(var32.func_75684_a()) {
               this.func_73116_b(new Packet40EntityMetadata(this.field_73132_a.field_70157_k, var32, false));
            }
