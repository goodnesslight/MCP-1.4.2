...
public abstract class EntityLiving extends Entity {
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      p_70014_1_.func_74757_a("Invulnerable", this.field_83001_bt);
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.field_83001_bt = p_70037_1_.func_74767_n("Invulnerable");
      NBTTagList var2;
      int var3;
   ...
   public void func_70636_d() {
      ...
      Iterator var12;
      if(!this.field_70170_p.field_72995_K) {
         var2 = this.field_70170_p.func_72839_b(this, this.field_70121_D.func_72314_b(0.20000000298023224D, 0.0D, 0.20000000298023224D));
      ...
      if(!this.field_70170_p.field_72995_K && this.field_82172_bs && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
         var2 = this.field_70170_p.func_72872_a(EntityItem.class, this.field_70121_D.func_72314_b(1.0D, 0.0D, 1.0D));
         var12 = var2.iterator();

         while(var12.hasNext()) {
            EntityItem var13 = (EntityItem)var12.next();
            if(!var13.field_70128_L && var13.field_70294_a != null) {
               ItemStack var14 = var13.field_70294_a;
               ...
               if(var6 > -1) {
                  ...
                  if(var8 != null) {
                     if(var6 == 0) {
                        if(var14.func_77973_b() instanceof ItemSword && !(var8.func_77973_b() instanceof ItemSword)) {
                           var15 = true;
                        } else if(var14.func_77973_b() instanceof ItemSword && var8.func_77973_b() instanceof ItemSword) {
                           ItemSword var9 = (ItemSword)var14.func_77973_b();
                           ItemSword var10 = (ItemSword)var8.func_77973_b();
                           if(var9.func_82803_g() == var10.func_82803_g()) {
                              var15 = var14.func_77960_j() > var8.func_77960_j() || var14.func_77942_o() && !var8.func_77942_o();
                           } else {
                     ...
                     } else if(var14.func_77973_b() instanceof ItemArmor && !(var8.func_77973_b() instanceof ItemArmor)) {
                        var15 = true;
                     } else if(var14.func_77973_b() instanceof ItemArmor && var8.func_77973_b() instanceof ItemArmor) {
                        ItemArmor var16 = (ItemArmor)var14.func_77973_b();
                        ItemArmor var17 = (ItemArmor)var8.func_77973_b();
                        if(var16.field_77879_b == var17.field_77879_b) {
                           var15 = var14.func_77960_j() > var8.func_77960_j() || var14.func_77942_o() && !var8.func_77942_o();
                        } else {
                           var15 = var16.field_77879_b > var17.field_77879_b;
                        }
                     } else {
                        var15 = false;
                     }
