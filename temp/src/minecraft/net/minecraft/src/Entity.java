...
public abstract class Entity {
   ...
   public void func_70030_z() {
      ...
      if(this.func_70051_ag() && !this.func_70090_H()) {
         ...
         var9 = MathHelper.func_76128_c(this.field_70161_v);
         int var4 = this.field_70170_p.func_72798_a(var6, var2, var9);
         if(var4 > 0) {
      ...
      if(this.func_70072_I()) {
         if(!this.field_70171_ac && !this.field_70148_d) {
            float var7 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w * 0.20000000298023224D + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y * 0.20000000298023224D) * 0.2F;
            if(var7 > 1.0F) {
               var7 = 1.0F;
            }

            this.field_70170_p.func_72956_a(this, "liquid.splash", var7, 1.0F + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.4F);
            float var8 = (float)MathHelper.func_76128_c(this.field_70121_D.field_72338_b);

            float var5;
            float var10;
            for(var9 = 0; (float)var9 < 1.0F + this.field_70130_N * 20.0F; ++var9) {
               var10 = (this.field_70146_Z.nextFloat() * 2.0F - 1.0F) * this.field_70130_N;
               var5 = (this.field_70146_Z.nextFloat() * 2.0F - 1.0F) * this.field_70130_N;
               this.field_70170_p.func_72869_a("bubble", this.field_70165_t + (double)var10, (double)(var8 + 1.0F), this.field_70161_v + (double)var5, this.field_70159_w, this.field_70181_x - (double)(this.field_70146_Z.nextFloat() * 0.2F), this.field_70179_y);
            }

            for(var9 = 0; (float)var9 < 1.0F + this.field_70130_N * 20.0F; ++var9) {
               var10 = (this.field_70146_Z.nextFloat() * 2.0F - 1.0F) * this.field_70130_N;
               var5 = (this.field_70146_Z.nextFloat() * 2.0F - 1.0F) * this.field_70130_N;
               this.field_70170_p.func_72869_a("splash", this.field_70165_t + (double)var10, (double)(var8 + 1.0F), this.field_70161_v + (double)var5, this.field_70159_w, this.field_70181_x, this.field_70179_y);
            }
         }
   ...
   public void func_70091_d(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if(this.field_70145_X) {
         ...
         AxisAlignedBB var23;
         for(Iterator var22 = var36.iterator(); var22.hasNext(); p_70091_3_ = var23.func_72323_b(this.field_70121_D, p_70091_3_)) {
         ...
         AxisAlignedBB var24;
         Iterator var35;
         for(var35 = var36.iterator(); var35.hasNext(); p_70091_1_ = var24.func_72316_a(this.field_70121_D, p_70091_1_)) {
         ...
         for(var35 = var36.iterator(); var35.hasNext(); p_70091_5_ = var24.func_72322_c(this.field_70121_D, p_70091_5_)) {
            var24 = (AxisAlignedBB)var35.next();
         }
         ...
         if(this.field_70138_W > 0.0F && var34 && (var20 || this.field_70139_V < 0.05F) && (var13 != p_70091_1_ || var17 != p_70091_5_)) {
            ...
            AxisAlignedBB var31;
            Iterator var30;
            for(var30 = var36.iterator(); var30.hasNext(); p_70091_3_ = var31.func_72323_b(this.field_70121_D, p_70091_3_)) {
            ...
            for(var30 = var36.iterator(); var30.hasNext(); p_70091_1_ = var31.func_72316_a(this.field_70121_D, p_70091_1_)) {
               var31 = (AxisAlignedBB)var30.next();
            }
            ...
            for(var30 = var36.iterator(); var30.hasNext(); p_70091_5_ = var31.func_72322_c(this.field_70121_D, p_70091_5_)) {
               var31 = (AxisAlignedBB)var30.next();
            }
            ...
            if(var37 * var37 + var27 * var27 >= p_70091_1_ * p_70091_1_ + p_70091_5_ * p_70091_5_) {
               ...
               double var38 = this.field_70121_D.field_72338_b - (double)((int)this.field_70121_D.field_72338_b);
               if(var38 > 0.0D) {
                  this.field_70139_V = (float)((double)this.field_70139_V + var38 + 0.01D);
               }
            }
         }
         ...
         if(this.func_70041_e_() && !var20 && this.field_70154_o == null) {
            ...
            int var42 = MathHelper.func_76128_c(this.field_70163_u - 0.20000000298023224D - (double)this.field_70129_M);
            int var41 = MathHelper.func_76128_c(this.field_70161_v);
            int var32 = this.field_70170_p.func_72798_a(var39, var42, var41);
            if(var32 == 0 && this.field_70170_p.func_72798_a(var39, var42 - 1, var41) == Block.field_72031_aZ.field_71990_ca) {
               var32 = this.field_70170_p.func_72798_a(var39, var42 - 1, var41);
            }
            ...
            if(this.field_82151_R > (float)this.field_70150_b && var32 > 0) {
               ...
               if(this.func_70090_H()) {
                  float var33 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w * 0.20000000298023224D + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y * 0.20000000298023224D) * 0.35F;
                  if(var33 > 1.0F) {
                     var33 = 1.0F;
                  }

                  this.field_70170_p.func_72956_a(this, "liquid.swim", var33, 1.0F + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.4F);
               }

               this.func_70036_a(var39, var42, var41, var32);
               Block.field_71973_m[var32].func_71891_b(this.field_70170_p, var39, var42, var41, this);
            }
         }
