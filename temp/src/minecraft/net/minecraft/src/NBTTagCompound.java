...
public class NBTTagCompound extends NBTBase {
   ...
   private CrashReport func_82581_a(String p_82581_1_, int p_82581_2_, ClassCastException p_82581_3_) {
      CrashReport var4 = new CrashReport("Reading NBT data", p_82581_3_);
      var4.func_71500_a("Corrupt tag type found", new CallableTagCompound1(this, p_82581_1_));
      var4.func_71500_a("Corrupt tag type expected", new CallableTagCompound2(this, p_82581_2_));
      var4.func_71507_a("Corrupt tag name", p_82581_1_);
      return var4;
   }
