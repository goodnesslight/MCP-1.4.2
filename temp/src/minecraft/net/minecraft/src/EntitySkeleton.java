...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob {
   ...
   protected void func_70036_a(int p_70036_1_, int p_70036_2_, int p_70036_3_, int p_70036_4_) {
      this.field_70170_p.func_72956_a(this, "mob.skeleton.step", 0.15F, 1.0F);
   }
   ...
   public void func_82163_bD() {
      if(this.field_70170_p.field_73011_w instanceof WorldProviderHell && this.func_70681_au().nextInt(5) > 0) {
         this.field_70714_bg.func_75776_a(4, new EntityAIAttackOnCollide(this, EntityPlayer.class, this.field_70697_bw, false));
         this.func_82201_a(1);
         this.func_70062_b(0, new ItemStack(Item.field_77711_v));
      } else {
         this.field_70714_bg.func_75776_a(4, new EntityAIArrowAttack(this, this.field_70697_bw, 60, 10.0F));
         this.func_82164_bB();
         this.func_82162_bC();
      }
   ...
   public void func_82196_d(EntityLiving p_82196_1_) {
      ...
      this.field_70170_p.func_72956_a(this, "random.bow", 1.0F, 1.0F / (this.func_70681_au().nextFloat() * 0.4F + 0.8F));
