...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   public void func_70071_h_() {
      ...
      if(!this.field_71129_f.isEmpty()) {
         ...
         Iterator var2 = this.field_71129_f.iterator();
         ...
         while(var2.hasNext() && var1.size() < 5) {
            ...
            if(var4 != null && this.field_70170_p.func_72899_e(var4.field_77276_a << 4, 0, var4.field_77275_b << 4)) {
               var1.add(this.field_70170_p.func_72964_e(var4.field_77276_a, var4.field_77275_b));
         ...
         if(!var1.isEmpty()) {
            this.field_71135_a.func_72567_b(new Packet56MapChunks(var1));
      ...
      if(!this.field_71130_g.isEmpty()) {
         int var6 = Math.min(this.field_71130_g.size(), 127);
         int[] var7 = new int[var6];
         Iterator var8 = this.field_71130_g.iterator();
         int var10 = 0;
         ...
         this.field_71135_a.func_72567_b(new Packet29DestroyEntity(var7));
      }
