...
public class EntityTrackerEntry
{
    ...
    public void updatePlayerList(List par1List)
    {
        ...
        if (this.trackedEntity instanceof EntityItemFrame && this.updateCounter % 10 == 0)
        {
            ...
            if (var24 != null && var24.getItem() instanceof ItemMap)
            {
                ...
                while (var27.hasNext())
                {
                    ...
                    if (var30.playerNetServerHandler.getNumChunkDataPackets() <= 5)
                    {
                        Packet var31 = Item.map.getUpdatePacket(var24, this.trackedEntity.worldObj, var30);

                        if (var31 != null)
                        {
                            var30.playerNetServerHandler.sendPacket(var31);
                        }
                    }
                }
            }
        ...
        else if (this.updateCounter++ % this.updateFrequency == 0 || this.trackedEntity.isAirBorne)
        {
            ...
            var2 = MathHelper.floor_float(this.trackedEntity.func_70079_am() * 256.0F / 360.0F);
            ...
            else if (!(this.trackedEntity instanceof IAnimals) && !(this.trackedEntity instanceof EntityDragon))
            {
                ...
                else
                {
                    ...
                    else if (this.trackedEntity instanceof EntityFallingSand)
                    {
                        ...
                        return new Packet23VehicleSpawn(this.trackedEntity, 70, var5.blockID | var5.field_70285_b << 16);
                    }
                    ...
                    else if (this.trackedEntity instanceof EntityItemFrame)
                    {
                        ...
                        var2 = new Packet23VehicleSpawn(this.trackedEntity, 71, var4.field_82332_a);
