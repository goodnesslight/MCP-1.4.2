...
public abstract class EntityLiving extends Entity
{
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else
        {
            ...
            {
                if ((par1DamageSource == DamageSource.field_82728_o || par1DamageSource == DamageSource.field_82729_p) && this.getEquipmentInSlot(4) != null)
                {
    ...
    {
        if (this.func_70694_bm() != null && this.rand.nextFloat() < field_82177_b[this.worldObj.difficultySetting])
        {
            EnchantmentHelper.addRandomEnchantment(this.rand, this.func_70694_bm(), 5);
        }
