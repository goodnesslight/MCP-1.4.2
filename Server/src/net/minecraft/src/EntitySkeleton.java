...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    public void func_82196_d(EntityLiving par1EntityLiving)
    {
        ...
        int var3 = EnchantmentHelper.getEnchantmentLevel(Enchantment.power.effectId, this.func_70694_bm());
        int var4 = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, this.func_70694_bm());
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchantment.flame.effectId, this.func_70694_bm()) > 0 || this.func_82202_m() == 1)
        {
            var2.setFire(100);
        }
